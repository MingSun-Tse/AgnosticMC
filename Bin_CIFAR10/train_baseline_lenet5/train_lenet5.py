...
# my libs
from model import LeNet5, LeNet5_deeper
...
if __name__ == "__main__":
  ...
  # Set up model
  net = LeNet5_deeper(args.model) if args.deeper else LeNet5(args.model)
  net.cuda()

  # Prepare data
  data_train = datasets.MNIST('../data_MNIST',
                              train=True,
                              download=True,
  ...
  data_test = datasets.MNIST('../data_MNIST',
                              train=False,
                              download=True,
                              transform=transforms.Compose([
                                transforms.Resize((32, 32)),
